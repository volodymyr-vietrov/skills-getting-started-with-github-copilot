...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 15,
        "participants": ["avery@mergington.edu", "natalie@mergington.edu"]
    },
    "Soccer Team": {
        "description": "Train in soccer skills and compete in league matches",
        "schedule": "Mondays, Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "jordan@mergington.edu"]
    },
    "Art Club": {
